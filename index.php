        ...
        ?>
            ...
            <nav class="nav-menu">
                <ul>
                    ...
                    <li><a href="/admin/login/index.php" class="nav-link scrollto"><i class="bx bx-log-in"></i> <span>Login</span></a></li>
                </ul>
            </nav><!-- .nav-menu -->
            <button type="button" class="mobile-nav-toggle d-xl-none"><i class="icofont-navigation-menu"></i></button>
    ...
    <main id="main">
                    ...
                    <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                        ...
                        <div>
                            <ul class="row">
                                ...
                                <li class="col-lg-6"><i class="icofont-rounded-right"></i> <strong>Mobile :</strong> <?=$data['mobile']?></li>
                                <li class="col-lg-6"><i class="icofont-rounded-right"></i> <strong>City :</strong> <?=$data['city']?></li>
                                <li class="col-lg-6"><i class="icofont-rounded-right"></i> <strong>Degree :</strong> <?=$data['degree']?></li>
                                <li class="col-lg-6"><i class="icofont-rounded-right"></i> <strong>Website :</strong> <?=$data['website']?></li>
        ...
        <section id="skills" class="skills section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>Skills</h2>
                    <p>Di bawah ini adalah beberapa soft skill dan hard skill yang aku kuasai.</p>
                </div>
    ...
    ?>
        ...
        <section id="resume" class="resume">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>Resume</h2>
                    <p>Berikut adalah resume dari seorang Soma Zaky Thufaili.</p>
                </div>
                  ...
                  <div class="col-lg-4 col-md-6 portfolio-item">
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-links" title="<?=$data5['projectname']?>">
                                ...
                                <a href="assets/img/<?=$data5['projectpic']?>" data-gall="portfolioGallery" class="venobox" title="Portfolio"><i class="bx bx-plus"></i></a>
...
-->
    ...
    <footer id="footer">
        <div class="container">
            ...
            <div class="copyright">
                &copy; Copyright <strong><span>SZ Thufaili</span></strong>
            </div>

            <div class="credits">
                Designed by <a href="#">Yours Truly</a>
            </div>
        </div>
    </footer><!-- End  Footer -->
