...
?> 
    ...
    <input type="text" name="city" value="<?=$data['city']?>" class="form-control" id="city" placeholder="">
  </div>
        
        <div class="form-group col-md-6">
    <label for="degree">Degree</label>
    <input type="text" name="degree" value="<?=$data['degree']?>" class="form-control" id="degree" placeholder="">
  </div>
